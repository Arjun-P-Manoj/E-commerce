      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            quasi sit perferendis odit tempore laboriosam eum asperiores ea
            enim? Sit, exercitationem aperiam culpa provident vel dolore
            necessitatibus quasi quas?
          </p>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. A dolor,
            provident vitae eveniet voluptate quam tempore fugit expedita
            officiis in, assumenda autem. Cum et dolores, recusandae tempora
            aliquid quasi at.
          </p>
        </div>
      </div>
